		...
		const groups = [
			...
			Group('Punctuation', 'punc',
				[Single('em dash', '&mdash;'),
				 ...
				 Single('inverted question mark', '&iquest;'),
				 Single('inverted exclamation mark', '&iexcl;')]),
			...
			Group('Mathematical', 'math',
				[Single('times', '&times;'),
				 ...
				 Double('not equal', '&ne;',
						'one fifth', '&frac15;'),
				 Double('equivalent', '&ap;',
						'one fourth', '&frac14;'),
				 Double('not equivalent', '&nap;',
						'one third', '&frac13;'),
				 Double('degrees', '&deg;',
						'three eighths', '&frac38;'),
				 Double('infinity', '&infin;',
						'two fifths', '&frac25;'),
				 Double('for each', '&exist;',
						'one half', '&frac12;'),
				 Double('for all', '&forall;',
						'three fifths', '&frac35;'),
				 Double('element of', '&isin;',
						'five eighths', '&frac58;'),
				 Double('not an element of', '&notin;',
						'two thirds', '&frac23;'),
				 Double('subset of', '&sub;',
						'three fourths', '&frac34;'),
				 Double('not a subset of', '&nsub;',
						'four fifths', '&frac45;'),
				 Double('union', '&bigcup;',
						'five sixths', '&frac56;'),
				 Double('intersection', '&bigcap;',
