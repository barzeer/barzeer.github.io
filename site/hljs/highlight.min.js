...
},...B,..._,...M,I,P,...z,...q,U,V]}}})();hljs.registerLanguage("swift",e)})();/*! `xml` grammar compiled for Highlight.js 11.5.1 */
(()=>{var e=(()=>{"use strict";return e=>{
...
})();hljs.registerLanguage("xml",e)})();/*! `bash` grammar compiled for Highlight.js 11.5.1 */
...
;hljs.registerLanguage("javascript",e)})();/*! `sql` grammar compiled for Highlight.js 11.5.1 */
(()=>{var e=(()=>{"use strict";return e=>{
...
strings:i,keywords:u}}}})();hljs.registerLanguage("c",e)})();/*! `css` grammar compiled for Highlight.js 11.5.1 */
(()=>{var e=(()=>{"use strict"
...
;hljs.registerLanguage("css",e)})();/*! `csharp` grammar compiled for Highlight.js 11.5.1 */
...
;hljs.registerLanguage("csharp",e)})();/*! `java` grammar compiled for Highlight.js 11.5.1 */
(()=>{var e=(()=>{"use strict"
...
;hljs.registerLanguage("java",e)})();/*! `kotlin` grammar compiled for Highlight.js 11.5.1 */
(()=>{var e=(()=>{"use strict"
...
hljs.addPlugin({'before:highlightElement':({el,language})=>{if(language.toLowerCase()!=='html')el.innerHTML=el.innerHTML.replace(/<(em|var)>/g,'__$1__').replace(/<\/(em|var)>/g,'___$1__');}});
hljs.addPlugin({'after:highlightElement':({el,result})=>{if(result.language.toLowerCase()!=='html')el.innerHTML=el.innerHTML.replace(/___(em|var)__/g,'</$1>').replace(/__(em|var)__/g,'<$1>');}});
hljs.highlightAll();})();
